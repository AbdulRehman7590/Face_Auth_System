  ...
  return (
    <div className="space-y-6 max-w-md mx-auto">
      <Card className="overflow-hidden border-2 border-gray-200 rounded-lg shadow-lg">
        <div className="relative w-full" style={{ height: "425x" }}>
          {!capturedImage ? (
            isCapturing ? (
              <>
                <video
              ...
              <div className="flex flex-col h-full items-center justify-center gap-6 p-6 bg-gray-50">
                ...
                <div className="flex gap-4 w-full px-4">
                  <Button
                    onClick={startCamera}
                    size="lg"
                    className="flex-1 text-black bg-blue-600 hover:bg-blue-700 hover:text-gray-100 shadow-md"
                  >
                    <Camera className="mr-2 h-4 w-4" />
                    Open Camera
                  </Button>
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="flex-1 bg-white text-gray-800 hover:bg-blue-700 hover:text-gray-100 border-gray-300 shadow-md"
                  >
                    <Upload className="mr-2 h-4 w-4" />
                    Upload
                  </Button>
